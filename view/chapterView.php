  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col s1 m1 ">
        ...
        <a href="<?= HOST ?>chapter/id/<?=$chapter->getPreviousId()?>" class="btn-floating teal lighten-1
      ...
      <div id="nextChapterButton">
        <div class="col s1 offset-s9 m1 offset-m8 ">
          ...
          <a href="<?= HOST?>chapter/id/<?=$chapter->getNextId()?>" class="btn-floating teal lighten-1
                         ...
                         <p>
                           ...
                           <div id="modal<?= $i ?>" class="modal">
                             ...
                             <div class="modal-footer">
                               ...
                               <a href="<?= HOST ?>reportComment/idCom/<?= $comment->getId()?>/id/<?= $comment->getChapterId()?>" class="modal-close btn-flat">Confirmer</a>
                             </div>
                           </div>
                         </p>
                       </div>
    ...
    <div id="formComment">
      <form action="<?= HOST ?>addComment/id/<?= $chapter->getId() ?>" method="post">
        <div class="row">
          <div class="col s12 m8">
